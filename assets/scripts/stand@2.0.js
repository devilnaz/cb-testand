...
const TwoCell = {
  ...
  setup(props) {
    ...
    async function onBranchPut() {
      ...
      let response = await fetch('/cb-testand/json/changeBranch.json');
      let result = await response.json();
...
const Table = {
  ...
  setup() {
    ...
    Vue.onMounted(async () => {
      ...
      let response = await fetch('/cb-testand/json/getStandsInfo.json');
      let result = await response.json();
    ...
    async function getAllBranch() {
      ...
      let response = await fetch('/cb-testand/json/getBranchesDataList.json');
      let result = await response.json();
